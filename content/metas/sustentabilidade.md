...
subtitle: Produtos da Meta 10
report_date: 18 de junho de 2026
footer_left: "#INTERNO.TODOS | META 10 - SUSTENTABILIDADE"
...
5. Definir metas graduais de redução de custos, redução de papel, otimização de armazenamento e melhoria da eficiência operacional.
6. Integrar os resultados da Meta 10 às Metas 2, 6 e 7, especialmente nos temas de sistemas, políticas, preservação digital e governança arquivística.
...
| ----------------------------------------------------------------- | -------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------- |
| Ausência de dados confiáveis sobre custos e volumetria documental | Dificulta mensuração do retorno institucional                                    | Mapear custos de produção, armazenamento, recuperação, tramitação e descarte           |
| Sistemas subutilizados ou com funcionalidades não exploradas      | Mantém investimentos sem pleno retorno operacional                               | Levantar taxa de utilização, funcionalidades ociosas e oportunidades de racionalização |
| Passivo documental sem destinação adequada                        | Gera custos de armazenamento, risco jurídico e consumo desnecessário de recursos | Priorizar identificação de documentos com prazo vencido e aplicar regras de destinação |
| Cópias, duplicidades e múltiplas versões documentais              | Aumenta custos de armazenamento e dificulta localização da informação            | Implantar ações de deduplicação, controle de versões e racionalização de acervos       |
| Plano de sustentabilidade sem governança de implementação         | Reduz a efetividade das recomendações                                            | Definir responsáveis, indicadores, metas e ciclos de monitoramento                     |
